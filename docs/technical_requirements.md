...
- ссылки на социальные сети
	...
	- twitter
- пол
- работа (место, должность - одно поле)

При просмотре профиля любой видит следующие данные профиля: username, имя и фамилию, дата регистрации, аватар, био, локация, ссылки на соц. сети, пол, работа.
...
- Регистрация
- Подтверждение email
- Страница профиля + записи
- Форма редактирования профиля + общие настройки
...
- Страница записи
- Страница источника
- Страница типа источника
- Страница тега
- Список записей
- Поиск

Информационные и технически:
- О нас
- Политика конфиденциальности
- 404
- Заглушка
